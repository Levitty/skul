  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        jakarta: ['"Plus Jakarta Sans"', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'Roboto', 'system-ui', 'sans-serif'],
      },
      colors: {
      ...
      boxShadow: {
        ...
        "glass-lg": "0 8px 40px rgb(0,0,0,0.08)",
        "glass-xl": "0 25px 50px -12px rgb(0,0,0,0.12)",
